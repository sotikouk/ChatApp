...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        // get the variable of xml "chatMessage" and bind it to chatMessage of chatMessageList
        holder.getBinding().setVariable(BR.chatMessage, chatMessageList.get(position));
        // ensure that data from the model are bound to the UI elements in the layout
